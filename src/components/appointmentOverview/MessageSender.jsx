...
export default function MessageSender({client, date, hour}) {
  ...
  return (
      <div className="mt-8 rounded-xl border border-neutral-800 bg-neutral-950 p-6">
        ...
        <button onClick={() => {console.log(message)}} className="cursor-pointer flex w-full items-center justify-center gap-2 rounded-lg bg-green-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-green-500">
